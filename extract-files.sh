...
#adb pull /system/bin/CKPD-daemon ../../../vendor/zte/$DEVICE/proprietary/CKPD-daemon
...
# This file is generated by device/ztei/__DEVICE__/extract-files.sh - DO NOT EDIT
